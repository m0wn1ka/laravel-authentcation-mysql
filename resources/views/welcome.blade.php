...
<nav class="navbar navbar-expand-lg navbar-success bg-light">
  ...
  <img src="https://3asresearchsolutions.in/PMT/resources/views/Logo02.png" height="80px" width="200px">
   ...
   <div class="collapse navbar-collapse" id="navbarSupportedContent">
     ...
     <form class="d-flex">
      <div class="nav-item ">
          <a class="btn btn-outline-success m-0"  type="button" href="/register"  role="button"  >
          Registration
          </a>
</div>
...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="https://3asresearchsolutions.in/PMT/resources/views/rawpixel-752537-unsplash-1-768x522.jpg" class="d-block "alt="..."height="300px"width="1400px">
      <div class="carousel-caption d-none d-md-block">
    ...
    <div class="element-wrap" >
      <div class="container" style="padding-top: 100px;">
        <ul class="row m-0">
          <li class="col-lg-4">
            <div >
           <!-- <img src="https://3asresearchsolutions.in/PMT/resources/views/Logo02.png" alt="" width="200" height="240">--> <BR><BR><BR><BR><BR>
				<video width="200" height="120" loop autoplay muted controls id="vid">
  <source src="https://3asresearchsolutions.in/PMT/resources/views/3AS_Intro.mp4" type="video/mp4">
				</video>
            </div>
			</li>
          <li class="col-lg-4" >
    ...
    <form style="text-align:center ;"action="" method="post">
				  <font color=red>  <h1 style="text-align:center ;">3ASR Solutions</h1></font>
				  <font color=red>  <h2 style="text-align:center ;">Project Management <BR>DIY</h2></font>
			      @csrf
					  <div>
